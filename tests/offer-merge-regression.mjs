...
let n2=normalizer.normalize(merged,task);ok((n2.missingCriticalWorks||[]).length===0,'M04 critical scope must be closed after follow-up');ok(n2.comparable===true,'M05 completed offer must become comparable');
