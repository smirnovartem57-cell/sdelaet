...
const serviceCodes=['BALCONY_INSULATION','BALCONY_GLAZING','WINDOW_REPLACEMENT','WINDOW_REPAIR','BALCONY_FINISHING','BALCONY_LEAK_REPAIR','ELECTRICAL_INSTALLATION','PLUMBING_WORKS','RADIATOR_HEATING','MINOR_APARTMENT_REPAIR','TILE_INSTALLATION'];
const categoryIds=['balcony-insulation','balcony-glazing','window-replacement','window-repair','balcony-finishing','balcony-leak-repair','electrical-installation','plumbing-works','radiator-heating','minor-apartment-repair','tile-installation'];
let fail=0;
