...
assert.equal(categories.length,60,'SEO generator must cover 60 non-balcony categories after expansion wave 3');
...
assert.equal((sitemap.match(/<url>/g)||[]).length,62,'sitemap must contain root, index and 60 category pages');
...
console.log('SEO category pages regression: 60/60 PASS');
