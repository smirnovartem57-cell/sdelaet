...
assert.equal(categories.length,29,'SEO generator must cover 29 non-balcony categories');
...
assert.equal((sitemap.match(/<url>/g)||[]).length,31,'sitemap must contain root, index and 29 category pages');
...
console.log('SEO category pages regression: 29/29 PASS');
