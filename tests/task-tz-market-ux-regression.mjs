...
ok(html.includes('#paywall .modal-card{width:min(1040px,calc(100vw - 28px));max-width:1040px;max-height:none;overflow:visible'),'desktop tariff modal v4 must not use internal scroll');
