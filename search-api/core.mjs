const CATEGORY_CONFIG = {
  ...
  'minor-apartment-repair': {companyQueries:['мелкий ремонт квартиры мастер','муж на час мелкий ремонт','мастер бытовой ремонт'],privateQueries:['муж на час мастер','мелкий ремонт мастер'],keywords:['ремонт','мастер','муж на час','сборк','креп'],qualifyKeywords:['мелкий ремонт','муж на час','мастер','сборка мебели','навес','крепеж']},
  'tile-installation': {companyQueries:['укладка плитки керамогранита','плиточник ванная','укладка керамогранита'],privateQueries:['плиточник укладка плитки','мастер по плитке'],keywords:['плитк','керамогранит','плиточник','облицов'],qualifyKeywords:['плитк','керамогранит','плиточник','облицов','затир']},
  'flooring-installation': {companyQueries:['укладка ламината пола','укладка кварц винила','укладка паркетной доски'],privateQueries:['мастер укладка ламината','укладка напольных покрытий'],keywords:['ламинат','кварц','spc','линолеум','паркет'],qualifyKeywords:['ламинат','spc','кварц','линолеум','паркет','напольн']},
  'wall-finishing': {companyQueries:['покраска стен ремонт Москва','поклейка обоев Москва','шпаклевка стен под покраску'],privateQueries:['маляр покраска стен','мастер поклейка обоев'],keywords:['покраск','обо','шпаклев','маляр'],qualifyKeywords:['покраска стен','обои','шпаклевка','малярные работы','подготовка стен']},
  'interior-doors': {companyQueries:['установка межкомнатных дверей Москва','монтаж дверей доборы наличники Москва'],privateQueries:['мастер установка межкомнатных дверей','установщик дверей'],keywords:['межкомнатн','двер','наличник','добор'],qualifyKeywords:['межкомнатные двери','установка дверей','доборы','наличники','дверной монтаж']},
  'stretch-ceiling': {companyQueries:['натяжные потолки Москва','теневые натяжные потолки Москва','натяжной потолок скрытый карниз'],privateQueries:['мастер натяжные потолки','монтаж натяжного потолка'],keywords:['натяжн','потол','тенев','карниз'],qualifyKeywords:['натяжные потолки','теневой потолок','скрытый карниз','световая линия','монтаж потолка']},
